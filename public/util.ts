...
const operations: operation[] = [
  ...
  },
  {
    ...
    endpoint: "/api/posts",
    method: "POST",
    fields: { text: "input",image:"input"},
  },
  {
    name: "Update Post",
    endpoint: "/api/posts/:id",
    method: "PATCH",
    fields: { id: "input", update: {text: "input",image:"input", options: { backgroundColor: "input" } } },
  },
  {
    name: "Delete Post",
    endpoint: "/api/posts/:id",
  ...
  },
  {
    ...
    endpoint: "/api/profiles",
    method: "PATCH",
    fields: { update: { name: "input", content: "input", features: "input" } },
  },
  {
    name: "Get Friend",
  ...
  },
  {
    ...
    endpoint: "/api/posts/:target/comments",
    method: "GET",
    fields: { target: "input" },
  },
  {
  ...
  },
  {
    ...
    endpoint: "/api/posts/:target/comments/:id",
    method: "PATCH",
    fields: { target: "input", id: "input", update: { text: "input" } },
  },
  {
